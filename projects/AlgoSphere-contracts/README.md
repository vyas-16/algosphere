...
By default the template creates a single `HelloWorld` contract under algosphere_core folder in the `smart_contracts` directory. To add a new contract:
